...
import type { StudentProfile } from '@/lib/academia/students';
import { Camera, Trash2 } from 'lucide-react';

export function StudentProfileForm({ initialProfile }: { initialProfile: StudentProfile }) {
  ...
  return (
    <div>
      <AlumnoPageHeader
        ...
        description="Actualiza tu información personal, contraseña y foto de perfil."
      />
