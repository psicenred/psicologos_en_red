...
import type { InstructorProfile } from '@/lib/academia/instructors';
import { Camera, Trash2 } from 'lucide-react';

export function InstructorProfileForm({ initialProfile }: { initialProfile: InstructorProfile }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const res = await fetch('/api/academia/instructor/profile', {
        method: 'PATCH',
  ...
  return (
    <div>
      <AlumnoPageHeader
        ...
        description="Actualiza tu información profesional, contraseña y foto de perfil."
      />
      ...
      <section className="mb-8 rounded-xl border border-[var(--color-arena)] bg-card p-6 shadow-sm">
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          JPG, PNG, WebP o GIF. Tamaño máximo 4 MB.
        </p>
      </section>
